...
import HappyResultsScroll from './components/HappyResultsScroll';
...
const SattaKing = () => {
  ...
  const [result, setResult] =useState([]);
    ...
    const shouldRenderHappyResultsScroll = result.length > 0;
  ...
  return (
    <div className="flex flex-col items-center bg-white">
      <div className="flex flex-col items-center bg-white w-screen">
        ...
        <div className="bg-green-700 text-white py-2 px-4 w-full text-center text-sm mb-4">
          Satta result, Satta king result, Satta king online, Mirzapur Satta,
          Gali result, Desawar result, Satta king chart, Mirzapur Satta Chart,
          Satta king live, Gali Satta, Deshawar live result, Gali live result,
          Satta matka,
        </div>
    ...
    { console.log({result})}
    {shouldRenderHappyResultsScroll &&  (<HappyResultsScroll result={result}/>) }
      ...
      <div className="w-full mt-4 mx-10">
        <BoxAB
          ...
          timeA="05:15 AM"
          // numberA="43"
          numberA={result[0]?.jodi || "XX"}
          cityNameB="NILAM BAZAR"
          timeB="12:45 PM"
          // numberB="45"
          numberB={result[1]?.jodi || "XX"}
